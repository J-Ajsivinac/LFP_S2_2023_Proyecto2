...
class Control:
    ...
    def promedio(self, valor):
        ...
        self.consola.insert("end", promedio + "\n")
    ...
    def get_max(self, i_d):
        valores = self.matriz[i_d]
        maximo = max(valores)
        self.consola.insert("end", maximo)

    def get_min(self, i_d):
        valores = self.matriz[i_d]
        minimo = min(valores)
        self.consola.insert("end", minimo)

    def exportar(self, nombre):
        self.consola.insert("end", f"exportando {nombre}")
